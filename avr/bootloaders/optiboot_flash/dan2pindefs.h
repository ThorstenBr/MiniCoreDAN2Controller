...
// custom STK parameter ID to obtain type of DANII board
#define STK_DANII_TYPE  0xD2

#define DAN_328P  3   // type 3 for ATmega328P ("3" is what old bootloaders always reported for unknown params, so we use this)
#define DAN_644P  4
